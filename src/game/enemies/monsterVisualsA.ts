...
export const VISUALS_A: Record<string, MonsterVisualSpec> = {
  ...
  ashling: {
    ...
    features: [
      ...
      F('cinderBreath', 60, 44, '#ff6a45', 0, 0.7),
    ],
    joints: [
      { id: 'root', parentId: null, anchor: { x: 60, y: 58 }, boundFeatures: [1, 6] },
      { id: 'head', parentId: 'root', anchor: { x: 60, y: 24 }, boundFeatures: [0] },
      { id: 'armL', parentId: 'root', anchor: { x: 28, y: 40 }, boundFeatures: [4] },
      { id: 'armR', parentId: 'root', anchor: { x: 92, y: 74 }, boundFeatures: [2] },
      { id: 'legL', parentId: 'root', anchor: { x: 34, y: 88 }, boundFeatures: [3] },
      { id: 'legR', parentId: 'root', anchor: { x: 40, y: 66 }, boundFeatures: [5] },
    ],
  },
  'cinder-sprite': {
    ...
    features: [
      ...
      F('flickerMote', 78, 34, '#ff6a45', 0, 0.6),
    ],
    joints: [
      { id: 'root', parentId: null, anchor: { x: 60, y: 56 }, boundFeatures: [4] },
      { id: 'head', parentId: 'root', anchor: { x: 60, y: 22 }, boundFeatures: [2, 5] },
      { id: 'armL', parentId: 'root', anchor: { x: 42, y: 46 }, boundFeatures: [0, 3] },
      { id: 'armR', parentId: 'root', anchor: { x: 78, y: 46 }, boundFeatures: [6] },
      { id: 'legL', parentId: 'root', anchor: { x: 50, y: 84 }, boundFeatures: [1] },
      { id: 'legR', parentId: 'root', anchor: { x: 70, y: 84 }, boundFeatures: [] },
    ],
  },
  'rust-hound': {
    ...
    features: [
      ...
      F('corrodedFang', 38, 56, '#a3542c', 0, 0.8),
    ],
    joints: [
      { id: 'root', parentId: null, anchor: { x: 52, y: 58 }, boundFeatures: [0, 2, 4] },
      { id: 'head', parentId: 'root', anchor: { x: 38, y: 30 }, boundFeatures: [1, 5, 7] },
      { id: 'armL', parentId: 'root', anchor: { x: 30, y: 64 }, boundFeatures: [] },
      { id: 'armR', parentId: 'root', anchor: { x: 70, y: 44 }, boundFeatures: [] },
      { id: 'legL', parentId: 'root', anchor: { x: 44, y: 90 }, boundFeatures: [6] },
      { id: 'legR', parentId: 'root', anchor: { x: 88, y: 70 }, boundFeatures: [3] },
    ],
  },
  'glass-moth': {
    ...
    features: [
      ...
      F('crystalVein', 74, 52, '#8be9d8', 0, 0.7),
    ],
    joints: [
      { id: 'root', parentId: null, anchor: { x: 60, y: 56 }, boundFeatures: [4] },
      { id: 'head', parentId: 'root', anchor: { x: 60, y: 18 }, boundFeatures: [3, 6] },
      { id: 'armL', parentId: 'root', anchor: { x: 40, y: 46 }, boundFeatures: [0, 1] },
      { id: 'armR', parentId: 'root', anchor: { x: 80, y: 46 }, boundFeatures: [] },
      { id: 'legL', parentId: 'root', anchor: { x: 50, y: 80 }, boundFeatures: [2] },
      { id: 'legR', parentId: 'root', anchor: { x: 70, y: 86 }, boundFeatures: [5] },
    ],
  },
  'veil-monger': {
    ...
    joints: [
      { id: 'root', parentId: null, anchor: { x: 60, y: 65 }, boundFeatures: [0, 5] },
      { id: 'head', parentId: 'root', anchor: { x: 60, y: 26 }, boundFeatures: [1, 6] },
      { id: 'armL', parentId: 'root', anchor: { x: 30, y: 72 }, boundFeatures: [2] },
      { id: 'armR', parentId: 'root', anchor: { x: 80, y: 58 }, boundFeatures: [3, 4] },
      { id: 'legL', parentId: 'root', anchor: { x: 48, y: 96 }, boundFeatures: [] },
  ...
  'bell-tender': {
    ...
    features: [
      ...
      F('vesperClapper', 60, 16, '#c98f2f', 0, 0.7),
    ],
    joints: [
      { id: 'root', parentId: null, anchor: { x: 60, y: 60 }, boundFeatures: [2] },
      { id: 'head', parentId: 'root', anchor: { x: 60, y: 30 }, boundFeatures: [6] },
      { id: 'armL', parentId: 'root', anchor: { x: 32, y: 70 }, boundFeatures: [1] },
      { id: 'armR', parentId: 'root', anchor: { x: 74, y: 40 }, boundFeatures: [0, 3] },
      { id: 'legL', parentId: 'root', anchor: { x: 46, y: 88 }, boundFeatures: [5] },
      { id: 'legR', parentId: 'root', anchor: { x: 72, y: 94 }, boundFeatures: [4] },
    ],
  },
  'kiln-brute': {
    ...
    features: [
      ...
      F('slagKnee', 40, 82, '#6e5a48', 0, 0.9),
    ],
    joints: [
      { id: 'root', parentId: null, anchor: { x: 60, y: 60 }, boundFeatures: [0, 6] },
      { id: 'head', parentId: 'root', anchor: { x: 60, y: 30 }, boundFeatures: [2, 3, 5] },
      { id: 'armL', parentId: 'root', anchor: { x: 35, y: 55 }, boundFeatures: [] },
      { id: 'armR', parentId: 'root', anchor: { x: 92, y: 55 }, boundFeatures: [1] },
      { id: 'legL', parentId: 'root', anchor: { x: 40, y: 82 }, boundFeatures: [4, 7] },
      { id: 'legR', parentId: 'root', anchor: { x: 76, y: 82 }, boundFeatures: [] },
    ],
  },
  'ink-leech': {
    ...
    features: [
      ...
      F('blotTip', 88, 64, '#4fd8c2', 0, 0.7),
    ],
    joints: [
      { id: 'root', parentId: null, anchor: { x: 60, y: 60 }, boundFeatures: [4] },
      { id: 'head', parentId: 'root', anchor: { x: 34, y: 40 }, boundFeatures: [1, 5] },
      { id: 'armL', parentId: 'root', anchor: { x: 30, y: 66 }, boundFeatures: [2] },
      { id: 'armR', parentId: 'root', anchor: { x: 88, y: 64 }, boundFeatures: [6] },
      { id: 'legL', parentId: 'root', anchor: { x: 50, y: 92 }, boundFeatures: [0, 3] },
  ...
  'bone-scrivener': {
    ...
    joints: [
      ...
      { id: 'head', parentId: 'root', anchor: { x: 60, y: 26 }, boundFeatures: [5] },
      { id: 'armL', parentId: 'root', anchor: { x: 36, y: 44 }, boundFeatures: [1] },
      { id: 'armR', parentId: 'root', anchor: { x: 86, y: 68 }, boundFeatures: [3] },
      { id: 'legL', parentId: 'root', anchor: { x: 46, y: 84 }, boundFeatures: [6] },
      { id: 'legR', parentId: 'root', anchor: { x: 78, y: 92 }, boundFeatures: [4] },
    ],
  },
  'ashen-warden': {
    ...
    features: [
      ...
      F('greavePlate', 60, 92, '#5c544c', 0, 0.9),
    ],
    joints: [
      { id: 'root', parentId: null, anchor: { x: 60, y: 60 }, boundFeatures: [1, 6] },
      { id: 'head', parentId: 'root', anchor: { x: 60, y: 22 }, boundFeatures: [0, 3, 4] },
      { id: 'armL', parentId: 'root', anchor: { x: 35, y: 55 }, boundFeatures: [] },
      { id: 'armR', parentId: 'root', anchor: { x: 94, y: 50 }, boundFeatures: [5] },
      { id: 'legL', parentId: 'root', anchor: { x: 48, y: 80 }, boundFeatures: [2] },
      { id: 'legR', parentId: 'root', anchor: { x: 72, y: 92 }, boundFeatures: [7] },
    ],
  },
  'crownless-furnace': {
    kind: 'vessel', hue: '#5c4a3c', hue2: '#3a2e24', glow: '#ff6a45', size: 1.4, eye: 'red',
    features: [
    ...
    joints: [
      ...
      { id: 'head', parentId: 'root', anchor: { x: 60, y: 20 }, boundFeatures: [0, 2] },
      { id: 'armL', parentId: 'root', anchor: { x: 35, y: 50 }, boundFeatures: [7] },
      { id: 'armR', parentId: 'root', anchor: { x: 92, y: 30 }, boundFeatures: [5] },
