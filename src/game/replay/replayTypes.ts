export type ReplayActionType = 'start-run' | 'enter-node' | 'play-card' | 'end-turn' | 'use-potion' | 'claim-reward' | 'event-choice' | 'shop-purchase' | 'special-choice' | 'leave-special' | 'abandon-run';
