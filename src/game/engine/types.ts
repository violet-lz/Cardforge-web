...
export interface MetaProgressState { schemaVersion: number; ascensionLevel: number; unlockedCharacterIds: string[]; unlockedCardIds: string[]; unlockedRelicIds: string[]; achievements: string[]; discoveredCharacterIds: string[]; discoveredCardIds: string[]; discoveredEnemyIds: string[]; discoveredRelicIds: string[]; discoveredPotionIds: string[]; upgradePoints: number; characterUpgrades: Record<string, CharacterUpgrades>; }
